...
## 🌍 Demo Site / デモサイト
**Demo Link / デモサイト:** [https://furuyan1234.github.io/ai-voice-comic-maker/](https://furuyan1234.github.io/ai-voice-comic-maker/)
...
2. **Run VOICEVOX / VOICEVOX起動**: Ensure VOICEVOX is running locally on port 50021. / VOICEVOXをローカル（ポート50021）で起動しておきます。
3. **Start / 開始**: Run `npm install` followed by `npm run dev` to launch the server and browser. / `npm install` の後、`npm run dev` を実行するとサーバーとブラウザが立ち上がります。
